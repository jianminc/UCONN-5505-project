...
getcatgraph <- function(v,crash){
  ...
  ggsave(file=paste("./../../image/",as.character(v),"_all_",as.character(crash),".png",sep=""), g)
  ...
  g <- arrangeGrob(g1,g2,nrow=2)
  ggsave(file=paste("./../../image/",v,"_3ST_",crash,".png",sep=""), g)
  ...
  g <- arrangeGrob(g1,g2,nrow=2)
  ggsave(file=paste("./../../image/",v,"_4ST_",crash,".png",sep=""), g)
  ...
  g <- arrangeGrob(g1,g2,nrow=2)
  ggsave(file=paste("./../../image/",v,"_4SG_",crash,".png",sep=""), g)
